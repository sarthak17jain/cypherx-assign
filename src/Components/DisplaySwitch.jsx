...
function DisplaySwitch() {
    ...
    return (
        <div className="display-switch-wrapper">
            <div className="display-switch" onClick={()=>setDisplaySwitchOpen(!displaySwitchOpen)} style={appliedTheme}>
            ...
            <section className={!displaySwitchOpen ? "dropdown-main" : "dropdown-main show"} style={appliedTheme}>
